  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
        <h2 className="text-2xl fond-bold mb-6 text-center">Create Acoount</h2>
        {msg && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input name='name' placeholder='Enter name' value={form.name} onChange={handleChange} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          required/>
